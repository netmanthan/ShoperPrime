...
const vm = this;
frappe.call({
method: "shoperprimepos.shoperprimepos.api.posapp.submit_invoice",
args: {
data: data,
...
if (e) {
frappe
.call("shoperprimepos.shoperprimepos.api.posapp.get_available_credit", {
...
frappe.call({
method: "shoperprimepos.shoperprimepos.api.posapp.get_customer_addresses",
...
frappe.call({
method: "shoperprimepos.shoperprimepos.api.posapp.get_sales_person_names",
callback: function (r) {
if (r.message) {
...
frappe
.call({
method: "shoperprimepos.shoperprimepos.api.posapp.create_payment_request",
args: {
doc: vm.invoice_doc,
},
})
