              ...
              >
                <v-card hover="hover" @click="add_item(item)">
                  <v-img
                    :src="
                      item.image ||
                      '/assets/shoperprimepos/js/posapp/components/pos/placeholder-image.png'
                    "
...
export default {
  ...
  methods: {
    ...
    get_items() {
      ...
      frappe.call({
        method: 'shoperprimepos.shoperprimepos.api.posapp.get_items',
        args: {
    ...
    get_items_groups() {
      ...
      if (this.pos_profile.item_groups.length > 0) {
        ...
        const vm = this;
        frappe.call({
          method: 'shoperprimepos.shoperprimepos.api.posapp.get_items_groups',
          args: {},
          callback: function (r) {
            if (r.message) {
