  ...
  methods: {
    ...
    cancel_invoice() {
      ...
      if (doc.name && this.pos_profile.posa_allow_delete) {
        frappe.call({
          method: "shoperprimepos.shoperprimepos.api.posapp.delete_invoice",
    ...
    update_invoice(doc) {
      const vm = this;
      frappe.call({
        method: "shoperprimepos.shoperprimepos.api.posapp.update_invoice",
        args: {
          data: doc,
        },
        async: false,
    ...
    get_draft_invoices() {
      const vm = this;
      frappe.call({
        method: "shoperprimepos.shoperprimepos.api.posapp.get_draft_invoices",
        args: {
    ...
    update_items_details(items) {
      ...
      frappe.call({
        method: "shoperprimepos.shoperprimepos.api.posapp.get_items_details",
        async: false,
        args: {
    ...
    update_item_detail(item) {
      const vm = this;
      frappe.call({
        method: "shoperprimepos.shoperprimepos.api.posapp.get_item_detail",
        args: {
    ...
    set_delivery_charges() {
      ...
      frappe.call({
        method:
          "shoperprimepos.shoperprimepos.api.posapp.get_applicable_delivery_charges",
        args: {
          company: this.pos_profile.company,
          pos_profile: this.pos_profile.name,
          customer: this.customer,
