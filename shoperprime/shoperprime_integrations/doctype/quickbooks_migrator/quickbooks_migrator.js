...
frappe.ui.form.on('QuickBooks Migrator', {
	...
	onload: function(frm) {
		...
		var redirect_url = `${domain}/api/method/shoperprime.shoperprime_integrations.doctype.quickbooks_migrator.quickbooks_migrator.callback`
	...
	refresh: function(frm) {
		...
		if (frm.doc.access_token) {
			...
			// All we need now is a Company from shoperprime
