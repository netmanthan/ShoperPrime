...
from shoperprime.shoperprime_integrations.doctype.mpesa_settings.mpesa_connector import MpesaConnector
from shoperprime.shoperprime_integrations.doctype.mpesa_settings.mpesa_custom_fields import (
	create_custom_pos_fields,
)
from shoperprime.shoperprime_integrations.utils import create_mode_of_payment
	...
	def request_for_payment(self, **kwargs):
		...
		for i, amount in enumerate(request_amounts):
			...
			if frappe.flags.in_test:
				from shoperprime.shoperprime_integrations.doctype.mpesa_settings.test_mpesa_settings import (
...
def generate_stk_push(**kwargs):
	...
	try:
		callback_url = (
			...
			+ "/api/method/shoperprime.shoperprime_integrations.doctype.mpesa_settings.mpesa_settings.verify_transaction"
		)
...
def get_account_balance(request_payload):
	...
	try:
		...
		callback_url = (
			get_request_site_address(True)
			+ "/api/method/shoperprime.shoperprime_integrations.doctype.mpesa_settings.mpesa_settings.process_balance_info"
		)
