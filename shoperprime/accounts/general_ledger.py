...
from shoperprime.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from shoperprime.accounts.doctype.budget.budget import validate_expense_against_budget
from shoperprime.accounts.utils import create_payment_ledger_entry
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else shoperprime.get_default_company()
