...
class TestTaxDetail(unittest.TestCase):
	def load_testdocs(self):
		from shoperprime.accounts.utils import FiscalYearError, get_fiscal_year
	...
	def rm_testdocs(self):
		...
		from shoperprime.setup.doctype.company.company import create_transaction_deletion_request
