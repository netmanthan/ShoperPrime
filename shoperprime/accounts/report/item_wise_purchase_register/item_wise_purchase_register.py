...
import shoperprime
from shoperprime.accounts.report.item_wise_sales_register.item_wise_sales_register import (
	add_sub_total_row,
	add_total_row,
	get_grand_total,
...
def _execute(filters=None, additional_table_columns=None):
	...
	company_currency = shoperprime.get_company_currency(filters.company)
