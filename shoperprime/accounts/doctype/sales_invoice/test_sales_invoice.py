...
import shoperprime
from shoperprime.accounts.doctype.account.test_account import create_account, get_inventory_account
from shoperprime.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from shoperprime.accounts.doctype.purchase_invoice.purchase_invoice import WarehouseMissingError
from shoperprime.accounts.doctype.purchase_invoice.test_purchase_invoice import (
	unlink_payment_on_cancel_of_invoice,
)
from shoperprime.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
from shoperprime.accounts.utils import PaymentEntryUnlinkError
from shoperprime.assets.doctype.asset.depreciation import post_depreciation_entries
from shoperprime.assets.doctype.asset.test_asset import create_asset, create_asset_data
from shoperprime.controllers.accounts_controller import update_invoice_status
from shoperprime.controllers.taxes_and_totals import get_itemised_tax_breakup_data
from shoperprime.exceptions import InvalidAccountCurrency, InvalidCurrency
from shoperprime.stock.doctype.delivery_note.delivery_note import make_sales_invoice
from shoperprime.stock.doctype.item.test_item import create_item
from shoperprime.stock.doctype.purchase_receipt.test_purchase_receipt import make_purchase_receipt
from shoperprime.stock.doctype.serial_no.serial_no import SerialNoWarehouseError
from shoperprime.stock.doctype.stock_entry.test_stock_entry import (
	get_qty_after_transaction,
	make_stock_entry,
)
from shoperprime.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	create_stock_reconciliation,
)
from shoperprime.stock.utils import get_incoming_rate, get_stock_balance


class TestSalesInvoice(unittest.TestCase):
	def setUp(self):
		from shoperprime.stock.doctype.stock_ledger_entry.test_stock_ledger_entry import create_items
	...
	def test_payment_entry_unlink_against_invoice(self):
		from shoperprime.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
	...
	def test_payment(self):
		...
		from shoperprime.accounts.doctype.journal_entry.test_journal_entry import (
	...
	def test_outstanding_on_cost_center_allocation(self):
		# setup cost centers
		from shoperprime.accounts.doctype.cost_center.test_cost_center import create_cost_center
		from shoperprime.accounts.doctype.cost_center_allocation.test_cost_center_allocation import (
	...
	def test_pos_returns_with_repayment(self):
		from shoperprime.accounts.doctype.sales_invoice.sales_invoice import make_sales_return
	...
	def test_bin_details_of_packed_item(self):
		from shoperprime.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
		from shoperprime.stock.doctype.item.test_item import make_item
	...
	def _insert_purchase_receipt(self):
		from shoperprime.stock.doctype.purchase_receipt.test_purchase_receipt import (
	...
	def _insert_delivery_note(self):
		from shoperprime.stock.doctype.delivery_note.test_delivery_note import (
	...
	def test_serialized(self):
		from shoperprime.stock.doctype.serial_no.serial_no import get_serial_nos
		from shoperprime.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_serial_numbers_against_delivery_note(self):
		...
		"""
		from shoperprime.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from shoperprime.stock.doctype.serial_no.serial_no import get_serial_nos
		from shoperprime.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_outstanding_amount_after_advance_payment_entry_cancellation(self):
		...
		from shoperprime.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_rounding_adjustment_3(self):
		from shoperprime.accounts.doctype.accounting_dimension.test_accounting_dimension import (
			create_dimension,
			disable_dimension,
		)
	...
	def test_sales_invoice_with_shipping_rule(self):
		from shoperprime.accounts.doctype.shipping_rule.test_shipping_rule import create_shipping_rule
	...
	def test_sales_invoice_with_project_link(self):
		from shoperprime.projects.doctype.project.test_project import make_project
	...
	def test_inter_company_transaction_without_default_warehouse(self):
		...
		old_perpetual_inventory = shoperprime.is_perpetual_inventory_enabled("_Test Company 1")
	...
	def test_depreciation_on_return_of_sold_asset(self):
		from shoperprime.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_sales_invoice_against_supplier(self):
		from shoperprime.accounts.doctype.opening_invoice_creation_tool.test_opening_invoice_creation_tool import (
			make_customer,
		)
		from shoperprime.accounts.doctype.party_link.party_link import create_party_link
		from shoperprime.buying.doctype.supplier.test_supplier import create_supplier
	...
	def test_gain_loss_with_advance_entry(self):
		from shoperprime.accounts.doctype.journal_entry.test_journal_entry import make_journal_entry
...
def create_internal_parties():
	from shoperprime.selling.doctype.customer.test_customer import create_internal_customer
