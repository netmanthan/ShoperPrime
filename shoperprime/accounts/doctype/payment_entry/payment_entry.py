...
import shoperprime
from shoperprime.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_party_bank_account,
)
from shoperprime.accounts.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from shoperprime.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from shoperprime.accounts.doctype.tax_withholding_category.tax_withholding_category import (
	get_party_tax_withholding_details,
)
from shoperprime.accounts.general_ledger import make_gl_entries, process_gl_map
...
from shoperprime.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	def set_payment_req_status(self):
		from shoperprime.accounts.doctype.payment_request.payment_request import update_payment_req_status
	...
	def set_tax_withholding(self):
		...
		tax_withholding_details.update(
			{"cost_center": self.cost_center or shoperprime.get_default_cost_center(self.company)}
		)
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = (
				"credit" if shoperprime.get_party_account_type(self.party_type) == "Receivable" else "debit"
			)
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or shoperprime.get_company_currency(
		ref_doc.company
	)
