...
from shoperprime.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from shoperprime.buying.doctype.purchase_order.purchase_order import get_mapped_purchase_invoice
...
from shoperprime.controllers.accounts_controller import get_payment_terms
from shoperprime.controllers.buying_controller import QtyMismatchError
from shoperprime.exceptions import InvalidCurrency
...
from shoperprime.stock.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
from shoperprime.stock.tests.test_utils import StockTestMixin
...
class TestPurchaseInvoice(unittest.TestCase, StockTestMixin):
	...
	def test_gl_entries_without_perpetual_inventory(self):
		...
		self.assertTrue(not cint(shoperprime.is_perpetual_inventory_enabled(pi.company)))
		pi.insert()
		pi.submit()
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		self.assertTrue(cint(shoperprime.is_perpetual_inventory_enabled(pi.company)), 1)
	...
	def test_debit_note(self):
		from shoperprime.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from shoperprime.accounts.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
	...
	def test_offsetting_entries_for_accounting_dimensions(self):
		...
		from shoperprime.accounts.report.trial_balance.test_trial_balance import (
...
def create_tax_witholding_category(category_name, company, account):
	from shoperprime.accounts.utils import get_fiscal_year
