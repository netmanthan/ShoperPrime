...
from shoperprime import get_default_cost_center
from shoperprime.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from shoperprime.accounts.doctype.payment_entry.test_payment_entry import create_payment_entry
...
from shoperprime.accounts.test.accounts_mixin import AccountsTestMixin
...
class TestExchangeRateRevaluation(AccountsTestMixin, FrappeTestCase):
	...
	def test_04_get_account_details_function(self):
		...
		from shoperprime.accounts.doctype.exchange_rate_revaluation.exchange_rate_revaluation import (
			get_account_details,
		)
