...
import shoperprime
from shoperprime.accounts.doctype.process_payment_reconciliation.process_payment_reconciliation import (
	is_any_doc_running,
)
...
from shoperprime.controllers.accounts_controller import get_advance_payment_entries
...
class PaymentReconciliation(Document):
	...
	def get_jv_entries(self):
		...
		dr_or_cr = (
			...
			if shoperprime.get_party_account_type(self.party_type) == "Receivable"
				...
				"accounts": [
					{
						...
						"cost_center": inv.cost_center or shoperprime.get_default_cost_center(company),
