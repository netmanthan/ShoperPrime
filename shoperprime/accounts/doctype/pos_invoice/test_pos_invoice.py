...
from shoperprime.accounts.doctype.pos_invoice.pos_invoice import make_sales_return
...
class TestPOSInvoice(unittest.TestCase):
	...
	def test_loyalty_points(self):
		...
		from shoperprime.accounts.doctype.loyalty_program.test_loyalty_program import create_records
	...
	def test_merging_into_sales_invoice_with_discount(self):
		from shoperprime.accounts.doctype.pos_closing_entry.test_pos_closing_entry import (
			init_user_and_profile,
		)
		from shoperprime.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import (
	...
	def test_ignore_pricing_rule(self):
		from shoperprime.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from shoperprime.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
		from shoperprime.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from shoperprime.stock.doctype.serial_no.test_serial_no import get_serial_nos
		from shoperprime.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_returned_serial_no_case(self):
		...
		from shoperprime.stock.doctype.serial_no.serial_no import get_pos_reserved_serial_nos
		from shoperprime.stock.doctype.serial_no.test_serial_no import get_serial_nos
		from shoperprime.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
