...
class Account(NestedSet):
	...
	def autoname(self):
		from shoperprime.accounts.utils import get_autoname_with_number

		self.name = get_autoname_with_number(self.account_number, self.account_name, self.company)

	def validate(self):
		from shoperprime.accounts.utils import validate_field_number
				...
				doc.update(
					{
						...
						else shoperprime.get_company_currency(company),
