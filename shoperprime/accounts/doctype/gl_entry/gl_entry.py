...
from shoperprime.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from shoperprime.accounts.party import validate_party_frozen_disabled, validate_party_gle_currency
from shoperprime.accounts.utils import get_account_currency, get_fiscal_year
from shoperprime.exceptions import (
...
class GLEntry(Document):
	...
	def validate_currency(self):
		company_currency = shoperprime.get_company_currency(self.company)
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = shoperprime.get_company_currency(entries[0].company)
