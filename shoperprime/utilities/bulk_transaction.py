...
def task(doc_name, from_doctype, to_doctype):
	from shoperprime.accounts.doctype.payment_entry import payment_entry
	from shoperprime.accounts.doctype.purchase_invoice import purchase_invoice
	from shoperprime.accounts.doctype.sales_invoice import sales_invoice
	from shoperprime.buying.doctype.purchase_order import purchase_order
	from shoperprime.buying.doctype.supplier_quotation import supplier_quotation
	from shoperprime.selling.doctype.quotation import quotation
	from shoperprime.selling.doctype.sales_order import sales_order
	from shoperprime.stock.doctype.delivery_note import delivery_note
	from shoperprime.stock.doctype.purchase_receipt import purchase_receipt
