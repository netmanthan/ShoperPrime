...
from shoper.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
from shoper.stock.get_item_details import get_item_details
from shoper.accounts.doctype.pos_profile.pos_profile import get_item_groups
from frappe.utils.background_jobs import enqueue
from shoper.accounts.party import get_party_bank_account
from shoper.stock.doctype.batch.batch import (
    get_batch_no,
    get_batch_qty,
    set_batch_nos,
)
from shoper.accounts.doctype.payment_request.payment_request import (
    get_dummy_message,
    get_existing_payment_request_amount,
)

from shoper.accounts.doctype.loyalty_program.loyalty_program import (
...
def get_version():
    branch_name = get_app_branch("shoper")
