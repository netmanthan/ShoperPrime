...
from shoperprime.stock.doctype.item.item import get_item_details
from shoperprime.stock.get_item_details import get_conversion_factor, get_price_list_rate
...
class BOM(WebsiteGenerator):
	...
	def company_currency(self):
		return shoperprime.get_company_currency(self.company)
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None):
	from shoperprime.stock.doctype.stock_entry.stock_entry import get_operating_cost_per_unit
...
def make_variant_bom(source_name, bom_no, item, variant_items, target_doc=None):
	from shoperprime.manufacturing.doctype.work_order.work_order import add_variant_item
