...
from shoperprime.manufacturing.doctype.bom.bom import get_children as get_bom_children
from shoperprime.manufacturing.doctype.bom.bom import validate_bom_no
from shoperprime.manufacturing.doctype.work_order.work_order import get_item_details
from shoperprime.setup.doctype.item_group.item_group import get_item_group_defaults
from shoperprime.stock.get_item_details import get_conversion_factor
from shoperprime.stock.utils import get_or_make_bin
from shoperprime.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	def make_work_order(self):
		from shoperprime.manufacturing.doctype.work_order.work_order import get_default_warehouse
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from shoperprime.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from shoperprime.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
