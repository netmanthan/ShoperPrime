...
from shoperprime.manufacturing.doctype.bom.bom import (
	get_bom_item_rate,
	get_bom_items_as_dict,
	validate_bom_no,
)
from shoperprime.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from shoperprime.stock.doctype.batch.batch import make_batch
from shoperprime.stock.doctype.item.item import get_item_defaults, validate_end_of_life
...
from shoperprime.stock.stock_balance import get_planned_qty, update_bin_qty
from shoperprime.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
...
class WorkOrder(Document):
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from shoperprime.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_stock_return_entry(work_order):
	from shoperprime.stock.doctype.stock_entry.stock_entry import get_available_materials
