...
from shoperprime.manufacturing.doctype.job_card.job_card import (
...
from shoperprime.manufacturing.doctype.work_order.work_order import WorkOrder
...
class TestJobCard(FrappeTestCase):
	...
	def test_job_card_material_request_and_bom_details(self):
		from shoperprime.stock.doctype.material_request.material_request import make_stock_entry
	...
	def test_job_card_proccess_qty_and_completed_qty(self):
		from shoperprime.manufacturing.doctype.routing.test_routing import (
			create_routing,
			setup_bom,
			setup_operations,
		)
