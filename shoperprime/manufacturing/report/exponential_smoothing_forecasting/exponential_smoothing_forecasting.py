...
import shoperprime
from shoperprime.accounts.report.financial_statements import get_period_list
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = shoperprime.get_company_currency(self.filters.company)
