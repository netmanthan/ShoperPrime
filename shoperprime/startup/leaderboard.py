...
def get_leaderboards():
	leaderboards = {
		"Customer": {
			...
			"method": "shoperprime.startup.leaderboard.get_all_customers",
			"icon": "customer",
		},
		"Item": {
			"fields": [
			...
			"method": "shoperprime.startup.leaderboard.get_all_items",
			"icon": "stock",
		},
		"Supplier": {
			"fields": [
			...
			"method": "shoperprime.startup.leaderboard.get_all_suppliers",
			"icon": "buying",
		},
		"Sales Partner": {
			"fields": [
			...
			"method": "shoperprime.startup.leaderboard.get_all_sales_partner",
			"icon": "hr",
		},
		"Sales Person": {
			"fields": [{"fieldname": "total_sales_amount", "fieldtype": "Currency"}],
			"method": "shoperprime.startup.leaderboard.get_all_sales_person",
			"icon": "customer",
		},
	}
