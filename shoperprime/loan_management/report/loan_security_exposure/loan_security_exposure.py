...
import shoperprime
from shoperprime.loan_management.report.applicant_wise_loan_security_exposure.applicant_wise_loan_security_exposure import (
...
def get_data(filters):
	...
	currency = shoperprime.get_company_currency(filters.get("company"))
