...
from shoperprime.loan_management.doctype.loan_security_shortfall.loan_security_shortfall import (
...
class LoanRepayment(AccountsController):
	...
	def set_missing_values(self, amounts):
		...
		if not self.cost_center:
			self.cost_center = shoperprime.get_default_cost_center(self.company)
