...
from shoperprime.controllers.sales_and_purchase_return import get_rate_for_return
from shoperprime.controllers.stock_controller import StockController
from shoperprime.stock.doctype.item.item import set_item_default
from shoperprime.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from shoperprime.accounts.party import _get_party_details
			...
			from shoperprime.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from shoperprime.controllers.buying_controller import validate_item_type
