...
import shoperprime
from shoperprime.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from shoperprime.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
from shoperprime.controllers.accounts_controller import (
	validate_conversion_rate,
	validate_inclusive_tax,
	validate_taxes_and_charges,
)
from shoperprime.stock.get_item_details import _get_item_tax_template
...
class calculate_taxes_and_totals(object):
	...
	def validate_conversion_rate(self):
		...
		company_currency = shoperprime.get_company_currency(self.doc.company)
