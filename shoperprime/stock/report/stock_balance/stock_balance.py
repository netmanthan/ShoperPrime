...
from shoperprime.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from shoperprime.stock.utils import add_additional_uom_columns
...
class StockBalanceReport(object):
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = shoperprime.get_company_currency(self.filters.get("company"))
		else:
