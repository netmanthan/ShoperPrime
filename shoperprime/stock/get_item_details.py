...
from shoperprime import get_company_currency
from shoperprime.accounts.doctype.pricing_rule.pricing_rule import (
...
from shoperprime.stock.doctype.batch.batch import get_batch_no
from shoperprime.stock.doctype.item.item import get_item_defaults, get_uom_conv_factor
from shoperprime.stock.doctype.item_manufacturer.item_manufacturer import get_item_manufacturer_part_no
from shoperprime.stock.doctype.price_list.price_list import get_price_list_details
...
def validate_item_details(args, item):
	...
	from shoperprime.stock.doctype.item.item import validate_end_of_life
...
def get_basic_details(args, item, overwrite_warehouse=True):
	...
	if args.get("doctype") in purchase_doctypes and not frappe.db.get_single_value(
		...
		from shoperprime.buying.doctype.purchase_order.purchase_order import item_last_purchase_rate
...
def get_price_list_rate(args, item_doc, out=None):
	...
	if meta.get_field("currency") or args.get("currency"):
		...
		if not out.price_list_rate and args.transaction_type == "buying":
			from shoperprime.stock.doctype.item.item import get_last_purchase_details
...
def validate_conversion_rate(args, meta):
	from shoperprime.controllers.accounts_controller import validate_conversion_rate
...
def get_bin_details(item_code, warehouse, company=None, include_child_warehouses=False):
	...
	if warehouse:
		...
		from shoperprime.stock.doctype.warehouse.warehouse import get_child_warehouses
...
def get_batch_qty(batch_no, warehouse, item_code):
	from shoperprime.stock.doctype.batch import batch
