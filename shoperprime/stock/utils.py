...
from shoperprime.stock.valuation import FIFOValuation, LIFOValuation
...
def get_incoming_rate(args, raise_error_if_no_rate=True):
	...
	from shoperprime.stock.stock_ledger import (
	...
	if in_rate is None:
		in_rate = get_valuation_rate(
			...
			currency=shoperprime.get_company_currency(args.get("company")),
