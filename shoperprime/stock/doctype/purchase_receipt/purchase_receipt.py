...
from shoperprime.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	def make_item_gl_entries(self, gl_entries, warehouse_account=None):
		...
		stock_rbnb = None
		if shoperprime.is_perpetual_inventory_enabled(self.company):
...
def make_purchase_invoice(source_name, target_doc=None):
	from shoperprime.accounts.party import get_payment_terms_template
