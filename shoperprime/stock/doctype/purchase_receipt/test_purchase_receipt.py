...
import shoperprime
from shoperprime.accounts.doctype.account.test_account import get_inventory_account
from shoperprime.controllers.buying_controller import QtyMismatchError
from shoperprime.stock.doctype.item.test_item import create_item, make_item
from shoperprime.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from shoperprime.stock.doctype.serial_no.serial_no import SerialNoDuplicateError, get_serial_nos
from shoperprime.stock.doctype.warehouse.test_warehouse import create_warehouse
from shoperprime.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_make_purchase_invoice(self):
		from shoperprime.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_no_gl_entry(self):
		from shoperprime.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(shoperprime.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from shoperprime.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from shoperprime.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from shoperprime.buying.doctype.purchase_order.purchase_order import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from shoperprime.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
		from shoperprime.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from shoperprime.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from shoperprime.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from shoperprime.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from shoperprime.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from shoperprime.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from shoperprime.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from shoperprime.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from shoperprime.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from shoperprime.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from shoperprime.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_backdated_transaction_for_internal_transfer(self):
		from shoperprime.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from shoperprime.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from shoperprime.accounts.doctype.sales_invoice.sales_invoice import (
			make_inter_company_purchase_invoice,
		)
		from shoperprime.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
	...
	def test_disable_last_purchase_rate(self):
		from shoperprime.stock.get_item_details import get_item_details
	...
	def test_validate_received_qty_for_internal_pr(self):
		...
		from shoperprime.controllers.status_updater import OverAllowanceError
		from shoperprime.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
	...
	def test_purchase_receipt_with_backdated_landed_cost_voucher(self):
		from shoperprime.controllers.sales_and_purchase_return import make_return_doc
		from shoperprime.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_purchase_receipt_provisional_accounting(self):
		...
		from shoperprime.accounts.doctype.account.test_account import create_account
...
def prepare_data_for_internal_transfer():
	from shoperprime.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
