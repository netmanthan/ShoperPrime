...
from shoperprime.setup.doctype.item_group.item_group import invalidate_cache_for
from shoperprime.stock.doctype.item_default.item_default import ItemDefault
...
class Item(Document):
			...
			item_price = frappe.get_doc(
				{
					...
					"uom": self.stock_uom,
					"brand": self.brand,
					"currency": shoperprime.get_default_currency(),
	...
	def recalculate_bin_qty(self, new_name):
		from shoperprime.stock.stock_balance import repost_stock
...
def invalidate_item_variants_cache_for_website(doc):
	...
	from shoperprime.e_commerce.variant_selector.item_variants_cache import ItemVariantsCacheManager
...
def get_asset_naming_series():
	from shoperprime.assets.doctype.asset.asset import get_asset_naming_series
