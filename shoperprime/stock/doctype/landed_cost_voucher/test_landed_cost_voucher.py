...
from shoperprime.accounts.utils import update_gl_entries_after
from shoperprime.assets.doctype.asset.test_asset import create_asset_category, create_fixed_asset_item
...
class TestLandedCostVoucher(FrappeTestCase):
	...
	def test_multi_currency_lcv(self):
		from shoperprime.setup.doctype.currency_exchange.test_currency_exchange import (
			save_new_records,
			test_records,
		)
