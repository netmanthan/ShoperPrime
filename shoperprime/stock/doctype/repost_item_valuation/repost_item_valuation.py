...
import shoperprime
from shoperprime.accounts.general_ledger import validate_accounting_period
from shoperprime.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
...
def repost_gl_entries(doc):
	if not cint(shoperprime.is_perpetual_inventory_enabled(doc.company)):
		return
