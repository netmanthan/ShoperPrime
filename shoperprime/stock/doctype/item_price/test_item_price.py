...
from shoperprime.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
from shoperprime.stock.get_item_details import get_price_list_rate_for, process_args
...
class TestItemPrice(FrappeTestCase):
	...
	def test_addition_of_new_fields(self):
		# Based on https://github.com/frappe/shoperprime/issues/8456
