...
from shoperprime.controllers.item_variant import ItemTemplateCannotHaveStock
...
class StockLedgerEntry(Document):
	...
	def on_submit(self):
		...
		if not self.get("via_landed_cost_voucher"):
			from shoperprime.stock.doctype.serial_no.serial_no import process_serial_no
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from shoperprime.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from shoperprime.stock.utils import is_group_warehouse
