...
from shoperprime.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from shoperprime.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
class TestStockLedgerEntry(FrappeTestCase, StockTestMixin):
	...
	def test_negative_qty_with_precision(self):
		...
		from shoperprime.stock.utils import get_stock_balance
...
def setup_item_valuation_test(
	...
	from shoperprime.stock.doctype.batch.batch import make_batch
	from shoperprime.stock.doctype.item.test_item import make_item
