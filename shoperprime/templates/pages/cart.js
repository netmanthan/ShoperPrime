...
$.extend(shopping_cart, {
	...
	get_update_address_dialog() {
		let d = new frappe.ui.Dialog({
			...
			primary_action: () => {
				...
				frappe.call({
					type: "POST",
					method: "shoperprime.e_commerce.shopping_cart.cart.update_cart_address",
					freeze: true,
					args: {
						address_type,
						address_name
	...
	apply_shipping_rule: function(rule, btn) {
		return frappe.call({
			btn: btn,
			type: "POST",
			method: "shoperprime.e_commerce.shopping_cart.cart.apply_shipping_rule",
	...
	place_order: function(btn) {
		...
		return frappe.call({
			type: "POST",
			method: "shoperprime.e_commerce.shopping_cart.cart.place_order",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
	...
	request_quotation: function(btn) {
		...
		return frappe.call({
			type: "POST",
			method: "shoperprime.e_commerce.shopping_cart.cart.request_for_quotation",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					shopping_cart.unfreeze();
	...
	apply_coupon_code: function(btn) {
		return frappe.call({
			type: "POST",
			method: "shoperprime.e_commerce.shopping_cart.cart.apply_coupon_code",
			btn: btn,
			args : {
