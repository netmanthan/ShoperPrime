...
from shoperprime.regional.report.uae_vat_201.uae_vat_201 import (
	get_exempt_total,
...
from shoperprime.stock.doctype.warehouse.test_warehouse import get_warehouse_account
...
def create_warehouse(warehouse_name, properties=None, company=None):
	...
	warehouse_id = shoperprime.encode_company_abbr(warehouse_name, company)
