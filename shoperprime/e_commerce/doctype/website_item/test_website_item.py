...
from shoperprime.e_commerce.doctype.e_commerce_settings.e_commerce_settings import (
	get_shopping_cart_settings,
)
from shoperprime.e_commerce.doctype.e_commerce_settings.test_e_commerce_settings import (
	setup_e_commerce_settings,
)
from shoperprime.e_commerce.doctype.website_item.website_item import make_website_item
from shoperprime.e_commerce.shopping_cart.product_info import get_product_info_for_website
from shoperprime.stock.doctype.item.item import DataValidationError
...
class TestWebsiteItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from shoperprime.e_commerce.doctype.website_item.website_item import on_doctype_update
	...
	def test_website_item_breadcrumbs(self):
		...
		"""
		from shoperprime.setup.doctype.item_group.item_group import get_parent_item_groups
