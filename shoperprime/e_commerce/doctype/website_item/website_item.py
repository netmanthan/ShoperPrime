...
if TYPE_CHECKING:
	from shoperprime.stock.doctype.item.item import Item
...
from shoperprime.e_commerce.doctype.item_review.item_review import get_item_reviews
from shoperprime.e_commerce.redisearch_utils import (
	delete_item_from_index,
	insert_item_to_index,
	update_index_for_item,
)
from shoperprime.e_commerce.shopping_cart.cart import _set_price_list
from shoperprime.setup.doctype.item_group.item_group import (
	get_parent_item_groups,
	invalidate_cache_for,
)
from shoperprime.utilities.product import get_price
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_metatags(self, context):
		...
		context.metatags["og:site_name"] = "shoperprime"
...
def invalidate_cache_for_web_item(doc):
	...
	from shoperprime.stock.doctype.item.item import invalidate_item_variants_cache_for_website
