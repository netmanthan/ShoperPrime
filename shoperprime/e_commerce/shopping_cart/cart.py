...
from shoperprime.accounts.utils import get_account_name
from shoperprime.e_commerce.doctype.e_commerce_settings.e_commerce_settings import (
	get_shopping_cart_settings,
)
from shoperprime.utilities.product import get_web_item_qty_in_stock
...
def place_order():
	...
	from shoperprime.selling.doctype.quotation.quotation import _make_sales_order
...
def _set_price_list(cart_settings, quotation=None):
	...
	from shoperprime.accounts.party import get_default_price_list
...
def set_taxes(quotation, cart_settings):
	...
	from shoperprime.accounts.party import set_taxes
