...
from shoperprime.e_commerce.doctype.e_commerce_settings.e_commerce_settings import is_cart_enabled
...
def set_cart_count(login_manager):
	...
	if show_cart_count():
		from shoperprime.e_commerce.shopping_cart.cart import set_cart_count
