...
from shoperprime.e_commerce.variant_selector.utils import get_next_attribute_and_values
...
class TestVariantSelector(FrappeTestCase):
	...
	def test_item_attributes(self):
		...
		"""
		from shoperprime.e_commerce.variant_selector.utils import get_attributes_and_values
	...
	def test_exact_match_with_price(self):
		...
		"""
		from shoperprime.e_commerce.doctype.website_item.test_website_item import make_web_item_price
