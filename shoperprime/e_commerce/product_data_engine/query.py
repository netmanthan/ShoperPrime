...
from shoperprime.e_commerce.doctype.item_review.item_review import get_customer
from shoperprime.e_commerce.shopping_cart.product_info import get_product_info_for_website
from shoperprime.utilities.product import get_non_stock_item_status
...
class ProductQuery:
	...
	def build_item_group_filters(self, item_group):
		...
		from shoperprime.setup.doctype.item_group.item_group import get_child_groups_for_website
	...
	def get_stock_availability(self, item):
		from shoperprime.templates.pages.wishlist import (
