...
from shoperprime.e_commerce.doctype.website_item.test_website_item import create_regular_web_item
from shoperprime.e_commerce.product_data_engine.filters import ProductFiltersBuilder
from shoperprime.e_commerce.product_data_engine.query import ProductQuery
...
class TestProductDataEngine(unittest.TestCase):
	...
	def test_product_list_discount_filter_builder(self):
		...
		from shoperprime.e_commerce.doctype.website_item.test_website_item import (
			make_web_item_price,
	...
	def test_product_list_with_api(self):
		...
		from shoperprime.e_commerce.api import get_product_filter_data
