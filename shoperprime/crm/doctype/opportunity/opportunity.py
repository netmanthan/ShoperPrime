...
from shoperprime.crm.utils import (
	CRMNote,
	copy_comments,
	link_communications,
	link_open_events,
...
def make_quotation(source_name, target_doc=None):
	def set_missing_values(source, target):
		from shoperprime.controllers.accounts_controller import get_default_taxes_and_charges
...
def make_opportunity_from_communication(communication, company, ignore_communication_links=False):
	from shoperprime.crm.doctype.lead.lead import make_lead_from_communication
