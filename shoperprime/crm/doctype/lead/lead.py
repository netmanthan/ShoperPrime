...
from shoperprime.crm.utils import CRMNote, copy_comments, link_communications, link_open_events
...
def get_lead_details(lead, posting_date=None, company=None):
	...
	from shoperprime.accounts.party import set_address_details
