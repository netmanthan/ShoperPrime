...
from shoperprime.accounts.utils import get_balance_on, get_count_on, get_fiscal_year
...
class EmailDigest(Document):
	...
	def get_msg_html(self):
		...
		from shoperprime.setup.doctype.email_digest.quotes import get_random_quote
