...
from shoperprime.e_commerce.doctype.e_commerce_settings.e_commerce_settings import ECommerceSettings
...
class ItemGroup(NestedSet, WebsiteGenerator):
	...
	def validate_item_group_defaults(self):
		from shoperprime.stock.doctype.item.item import validate_item_default_company_links
