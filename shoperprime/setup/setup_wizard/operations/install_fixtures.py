...
from shoperprime.accounts.doctype.account.account import RootNotEditable
from shoperprime.regional.address_template.setup import set_up_address_templates
...
def install(country=None):
	...
	from shoperprime.buying.doctype.supplier_scorecard.supplier_scorecard import make_default_records
