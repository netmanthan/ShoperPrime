...
from shoperprime.accounts.party import (  # noqa
	get_dashboard_info,
	get_timeline_data,
...
class Supplier(TransactionBase):
	...
	def create_primary_contact(self):
		from shoperprime.selling.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from shoperprime.selling.doctype.customer.customer import make_address
