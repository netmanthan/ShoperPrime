...
from shoperprime.accounts.party import get_due_date_from_template
from shoperprime.buying.doctype.purchase_order.purchase_order import make_inter_company_sales_order
...
from shoperprime.controllers.accounts_controller import update_child_qty_rate
from shoperprime.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from shoperprime.stock.doctype.item.test_item import make_item
from shoperprime.stock.doctype.material_request.material_request import make_purchase_order
from shoperprime.stock.doctype.material_request.test_material_request import make_material_request
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from shoperprime.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from shoperprime.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from shoperprime.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_internal_transfer_flow(self):
		...
		from shoperprime.selling.doctype.sales_order.sales_order import (
			make_delivery_note,
			make_sales_invoice,
		)
