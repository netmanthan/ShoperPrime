...
import shoperprime.buying.doctype.supplier_scorecard_variable.supplier_scorecard_variable as variable_functions
from shoperprime.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria import (
	get_variables,
)
