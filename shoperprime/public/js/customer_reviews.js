	...
	class CustomerReviews {
			...
			$('.page_content').on('click', '.btn-write-review', (e) => {
				...
				let d = new frappe.ui.Dialog({
					...
					primary_action: function() {
						...
						frappe.call({
							method: "shoperprime.e_commerce.doctype.item_review.item_review.add_item_review",
							args: {
		...
		view_more() {
			$('.page_content').on('click', '.btn-view-more', (e) => {
				...
				frappe.call({
					method: "shoperprime.e_commerce.doctype.item_review.item_review.get_item_reviews",
					args: {
						web_item: $btn.attr('data-web-item'),
						start: me.start,
						end: me.page_length
