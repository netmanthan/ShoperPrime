...
from shoperprime.controllers.tests.test_subcontracting_controller import (
	get_rm_items,
...
class TestSubcontractingReceipt(FrappeTestCase):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from shoperprime.controllers.subcontracting_controller import (
			make_rm_stock_entry as make_subcontract_transfer_entry,
		)
		from shoperprime.subcontracting.doctype.subcontracting_order.subcontracting_order import (
			make_subcontracting_receipt,
		)
		from shoperprime.subcontracting.doctype.subcontracting_order.test_subcontracting_order import (
			make_subcontracted_item,
		)
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(shoperprime.is_perpetual_inventory_enabled(scr.company)), 1)
