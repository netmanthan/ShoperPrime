...
from shoperprime.erpnext_integrations.doctype.mpesa_settings.mpesa_connector import MpesaConnector
from shoperprime.erpnext_integrations.doctype.mpesa_settings.mpesa_custom_fields import (
	create_custom_pos_fields,
)
from shoperprime.erpnext_integrations.utils import create_mode_of_payment
	...
	def request_for_payment(self, **kwargs):
		...
		for i, amount in enumerate(request_amounts):
			...
			if frappe.flags.in_test:
				from shoperprime.erpnext_integrations.doctype.mpesa_settings.test_mpesa_settings import (
