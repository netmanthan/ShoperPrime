...
from shoperprime.accounts.party import get_due_date
from shoperprime.exceptions import PartyDisabled, PartyFrozen
from shoperprime.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
from shoperprime.tests.utils import create_test_contact_and_address
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from shoperprime.accounts.party import get_party_details
	...
	def test_serach_fields_for_customer(self):
		from shoperprime.controllers.queries import customer_query
