...
from shoperprime.accounts.party import get_party_account
from shoperprime.controllers.selling_controller import SellingController
from shoperprime.manufacturing.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from shoperprime.manufacturing.doctype.production_plan.production_plan import (
...
from shoperprime.stock.get_item_details import get_default_bom, get_price_list_rate
from shoperprime.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	def validate(self):
		...
		if self.coupon_code:
			from shoperprime.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from shoperprime.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_pick_list(source_name, target_doc=None):
	from shoperprime.stock.doctype.packed_item.packed_item import is_product_bundle
