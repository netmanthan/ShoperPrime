...
from shoperprime.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from shoperprime.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
...
class TestSalesOrder(FrappeTestCase):
	...
	def test_drop_shipping(self):
		from shoperprime.buying.doctype.purchase_order.purchase_order import update_status
		from shoperprime.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from shoperprime.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from shoperprime.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from shoperprime.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_serial_no_based_delivery(self):
		...
		from shoperprime.manufacturing.doctype.production_plan.test_production_plan import make_bom
		...
		so.submit()
		from shoperprime.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		...
		from shoperprime.manufacturing.doctype.work_order.work_order import (
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from shoperprime.controllers.item_variant import create_variant
		from shoperprime.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from shoperprime.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from shoperprime.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_sales_order_partial_advance_payment(self):
		...
		from shoperprime.selling.doctype.customer.test_customer import get_customer_dict
