...
class TestQuotation(FrappeTestCase):
	...
	def test_make_sales_order_terms_copied(self):
		from shoperprime.selling.doctype.quotation.quotation import make_sales_order
	...
	def test_quotation_expiry(self):
		from shoperprime.selling.doctype.quotation.quotation import set_expired_status
